...
import mapdata from './mapData/2020_zipCode.json'

function Map() { 
  return ( 
    <div>
      <MapContainer center={[40.4406,-79.9959]} zoom={12.5}>
      <GeoJSON style={{color: 'Black'}} data={pittZips()} />
        <TileLayer
...
//get all pittsburgh zip codes and return the GeoJSON object for them
function pittZips(){
